...
![Metadata search tool window.](posted_metasearch.png "Metadata search tool window")
...
![Add to new project from metadata search.](addnewproject_metasearch.png "Add to new project from metadata search")
...
![Navigate To window.](typeform_metasearch.png "Navigate To window")
...
![Metadata search filter button.](metadatasearchfilter.jpg "Metadata search filter button")
