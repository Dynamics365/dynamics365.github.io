...
![Blueprint](Blueprint.jpg "Blueprint")
...
<!-- 
  ![basic-c-oop-concept](EmptyHouse.jpg "EmptyHouse.jpg")
 -->
![EmptyHouse](EmptyHouse.jpg "EmptyHouse")
...
![CompleteHouse](CompleteHouse.jpg "CompleteHouse")
...
![basic-c-oop-concept](basic-c-oop-concept_1.png "basic-c-oop-concept_1.png")
...
![basic-c-oop-concept](basic-c-oop-concept_2.png "basic-c-oop-concept_2.png")
...
The Output of above class is here:
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_3.png "basic-c-oop-concept_3.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_4.png "basic-c-oop-concept_4.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_5.png "basic-c-oop-concept_5.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_6.png "basic-c-oop-concept_6.png")
...
The Error is:
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_7.png "basic-c-oop-concept_7.png")
...
Here we can see a simple Inheritance where the base class is the `GuestVist` and derived class is the `HouseOwnerClass`. Here `HouseOwnerClass` class inherits the base class of `GuestVist`
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_8.png "basic-c-oop-concept_8.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_9.png "basic-c-oop-concept_9.png")
...
See the below image which shows the Warning error message while I write Multiple Inheritance.
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_10.png "basic-c-oop-concept_10.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_11.png "basic-c-oop-concept_11.png")
...
Here we can see an error warning message as “An instance of an abstract class cannot be created” when I try to create an object for my abstract class.
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_12.png "basic-c-oop-concept_12.png")
...
Here we can see an abstract class has an abstract method, But the abstract method is not override in the derived class. See the below image for the warning message displaying as class must implement the abstract member.
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_13.png "basic-c-oop-concept_13.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_14.png "basic-c-oop-concept_14.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_15.png "basic-c-oop-concept_15.png")
...
Let’s see an example when I try to inherit my sealed class from my derived class. It shows me the below warning message.
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_16.png "basic-c-oop-concept_16.png")
...
Let’s see an example when I try to inherit my static class from my derived class. It shows me the below warning message.
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_17.png "basic-c-oop-concept_17.png")
...
Let’s see an example when I try to create a non-Static method at my Static Class.
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_18.png "basic-c-oop-concept_18.png")
...
Let’s see an example when I try to create an object for my Static Class.
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_19.png "basic-c-oop-concept_19.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_20.png "basic-c-oop-concept_20.png")
...
```
  ...
  ![basic-c-oop-concept](basic-c-oop-concept_21.png "basic-c-oop-concept_21.png")
