...
![Flow step 1](E2-1-Flow-1.png "The old flow")

We will add a step right before the new record is created.

![Flow step 2](E2-2-Flow-2.png "Add a new step")

We will go with `Approval > Start and wait for an approval`.

![Flow step 3](E2-3-Flow-3.png "Add approval request")
...
![Flow step 4](E2-4-Flow-4.png "Single approval")
...
![Flow step 5](E2-5-Flow-5.png "Revised flow")

#### 1.2. **Step 2: Testing out**

Trigger a `test` run of the flow.

![Flow step 6](E2-6-Flow-6.png "Test run")

![Flow step 7](E2-7-Flow-7.png "Test run triggered")

The `test` run is ready, waiting for the input from `MS Forms`.

![Flow step 8](E2-8-Flow-8.png "Test run ready")

Submit a new response.

![Flow step 9](E2-9-Flow-9.png "Form new response")

The flow will run. The process will show that an approval is being waited from the assigned user.

![Flow step 10](E2-10-Flow-10.png "Waiting for an approval")
...
![Flow step 11](E2-11-Flow-11.png "Approval request")

Upon approval, the flow will finish its pending step and a new record will be created.

![Flow step 12](E2-12-Flow-12.png "Flow finishes")
...
![SSMSBank](E3-1-SSMSBank.png "Relation in SSMS")
...
![DynamicsContent](E3-5-Flow-2.png "Selecting Dynamic Content from former steps")
...
![AdvancedOptions](E3-6-Flow-3.png "Select Show advanced options")
...
![BankDetails](E3-7-Flow-4.png "Add more details to bank account")
...
![VendorContact](E3-8-Flow-5.png "Vendor Contact Details")

#### 2.2. **Step 2: Testing out**

Form input.

![FormInput1](E3-9-Flow-6.png "Company details")

![FormInput2](E3-10-Flow-7.png "Bank details")

![FormInput3](E3-11-Flow-8.png "Contact details")

Results on D365FO client.

![Result1](E3-12-Flow-9.png "Contact details")

![Result2](E3-13-Flow-10.png "Bank account")

![Result3](E3-14-Flow-11.png "Bank account details")
...
![Info on Automate](E1-12-Flow-10.png "Info on Automate")
...
![Entity fields](VS-4-EntityFields.png "Entity fields")
