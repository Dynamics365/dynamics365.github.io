...
- [Getting and preparing the VHD](#getting-and-preparing-the-vhd)
- [Create a DevTest Labs account](#create-a-devtest-labs-account)
- [Creating the VM](#creating-the-vm)
  - [5.1. Configure Azure DevOps Agent Service](#51-configure-azure-devops-agent-service)
  - [5.2. Option A: use an artifact](#52-option-a-use-an-artifact)
  - [5.3. Option B: Configure Azure DevOps Agent in the VM](#53-option-b-configure-azure-devops-agent-in-the-vm)
  - [5.4. ARM template](#54-arm-template)
- [Preparing the VM](#preparing-the-vm)
  - [6.1. Disable services](#61-disable-services)
  - [6.2. Create a new SQL user](#62-create-a-new-sql-user)
  - [6.3. Prepare SSRS (optional)](#63-prepare-ssrs-optional)
  - [6.4. PowerShell Scripts](#64-powershell-scripts)
    - [6.4.1. PrepareForBuild](#641-prepareforbuild)
  - [6.5. **Optional (but recommended)**: install [d365fo.tools](https://github.com/d365collaborative/d365fo.tools)](#65-optional-but-recommended-install-d365fotools)
- [Create a new image](#create-a-new-image)
- [Azure DevOps Pipelines](#azure-devops-pipelines)
  - [8.1. Create Azure DevTest Labs VM](#81-create-azure-devtest-labs-vm)
  - [8.2. Build](#82-build)
    - [8.2.1. Optional: use SelectiveSync (not recommended, see next option)](#821-optional-use-selectivesync-not-recommended-see-next-option)
    - [8.2.2. Optional: use d365fo.tools to sync your packages/models](#822-optional-use-d365fotools-to-sync-your-packagesmodels)
    - [8.2.3. Optional: use d365fo.tools to deploy SSRS reports](#823-optional-use-d365fotools-to-deploy-ssrs-reports)
  - [8.3. Delete Azure DevTest Labs VM](#83-delete-azure-devtest-labs-vm)
  - [8.4. Dependencies and conditions](#84-dependencies-and-conditions)
    - [8.4.1. Build](#841-build)
    - [8.4.2. Delete VM](#842-delete-vm)
- [Run the build](#run-the-build)
- [Times](#times)
  - [10.1. Comparison 1](#101-comparison-1)
  - [10.2. Comparison 2](#102-comparison-2)
  - [10.3. Comparison 3](#103-comparison-3)
